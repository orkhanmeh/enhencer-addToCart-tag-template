...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Enhencer - Add to Cart",
  ...
  "description": "This tag has to fire after a product added to the cart successfully.",
  "containerContexts": [
    "WEB"
  ]
}
...
const addToCart = ()=>{
  let cons = callInWindow('enhencerCollector.addedToBasket', {productID: data.productID});
            ...
            "listItem": [
              ...
              },
              {
                ...
                "mapValue": [
                  {
                    "type": 1,
                    "string": "enhencerCollector.addedToBasket"
                  },
                  {
                    "type": 8,
                    "boolean": true
...
Created on 6/1/2021, 4:12:07 PM
